...
export const UPDATE_PROGRAM = gql`mutation UpdateProgram($id: ID!, $input: UpdateProgramInput!) { updateProgram(id: $id, input: $input) { ...ProgramFields } } ${PROGRAM_FIELDS}`;
...
export const UPDATE_COURSE = gql`mutation UpdateCourse($id: ID!, $input: UpdateCourseInput!) { updateCourse(id: $id, input: $input) { ...CourseFields } } ${COURSE_FIELDS}`;
